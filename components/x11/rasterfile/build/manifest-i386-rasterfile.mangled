set name=pkg.fmri value=pkg:/x11/header/rasterfile@7.5,5.11-2020.1.1.0
set name=com.oracle.info.name value=rasterfile
...
set name=pkg.summary value="rasterfile - Sun file format for raster images"
