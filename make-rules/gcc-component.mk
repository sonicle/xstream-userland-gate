...
GCC_COMPONENT_STRING_VERSION = $(COMPONENT_VERSION)-xs-$(COMPONENT_REVISION)
else
...
CONFIGURE_OPTIONS+= --with-pkgversion="XStreamOS $(GCC_COMPONENT_STRING_VERSION)"
CONFIGURE_OPTIONS+= --with-bugurl="https://bugs.xstreamos.org"
